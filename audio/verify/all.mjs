...
//   render-check     — offline render of all 4 sections: real/seamless/ducking/deterministic
//                      + distinctness + scene-gate + enrage; writes the WAV artifacts
...
const VERIFIERS = ['headless-safety', 'render-check', 'live-check', 'perf-soak'];
